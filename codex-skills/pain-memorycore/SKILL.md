...
description: "Load and operate Pain's MemoryCore in Codex. Use when the user says 'Pain', asks who Pain is, asks to load memory, starts work inside Project-AI-MemoryCore, needs Codex to apply persistent identity/relationship/session memory, or asks how this MemoryCore works in Codex versus Claude."
---
...
5. Treat Claude-specific plugin/hook files as compatibility artifacts, not Codex activation mechanisms.
...
- Use project-local `plugins/pain-skills/skills/*/SKILL.md` files as protocols unless a Codex-native skill exists.
- Keep answers direct, strategic, and practical.

## Reference

Read `references/memorycore-map.md` when you need the file map or runtime compatibility notes.
